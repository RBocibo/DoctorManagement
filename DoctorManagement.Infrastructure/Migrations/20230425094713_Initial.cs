        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfessionalStatement = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PracticingStartDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FollowUpConsulationFee = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DoctorId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompletedYear = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DoctorId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Doctor_SpecializationId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SpecializationId = table.Column<int>(type: "int", nullable: false),
                    DoctorId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Doctor_Specializations", x => x.Doctor_SpecializationId);
                    table.ForeignKey(
                        name: "FK_Doctor_Specializations_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "DoctorId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Doctor_Specializations_Specializations_SpecializationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Doctor_Specializations_DoctorId",
                table: "Doctor_Specializations",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_Doctor_Specializations_SpecializationId",
                table: "Doctor_Specializations",
